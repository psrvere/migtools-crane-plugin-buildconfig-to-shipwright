...
| `--default-build-strategy` | `docker=name,s2i=name` | Names a copy of a catalog strategy, not an upstream Shipwright one (ADR-0010). With a custom name the BuildRun template omits `stepResources` (W47) |
