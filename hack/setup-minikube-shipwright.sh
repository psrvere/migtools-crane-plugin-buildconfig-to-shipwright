...
#   --shipwright-version   Shipwright version (default: v0.21.0)
...
MEMORY="${MEMORY:-8192}"
DRIVER="${DRIVER:-}"
SHIPWRIGHT_VERSION="${SHIPWRIGHT_VERSION:-v0.21.0}"
...
print_summary() {
    ...
    log ""
    log "To test with crane-plugin-buildconfig-to-builds:"
    log "  1. Build the plugin: go build -o crane-plugin-buildconfig-to-builds ."
