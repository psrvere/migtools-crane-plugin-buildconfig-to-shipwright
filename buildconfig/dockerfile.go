...
func (c *Converter) processInlineDockerfile(bc *buildv1.BuildConfig, b *shipwrightv1beta1.Build) *corev1.ConfigMap {
	...
	case buildv1.DockerBuildStrategyType:
		...
		// Recorded at ERROR (not through warnf, which logs at WARN) to stay as loud
		// as the BUILD-2275 drop: the Build does not build from this content until
		// BUILD-1495 gives the strategy a way to consume it.
