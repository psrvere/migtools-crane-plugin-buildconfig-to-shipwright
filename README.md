...
> `docs/support-matrix.md`, `docs/examples/` and `docs/architecture.md` land in PRs #64, #65
> and #66 to #68. Until those merge, the links below and the ones above point at files that
> do not exist yet.
