...
report mode. Nothing here forks a Skill, so nothing runs on the session model. Security
depth is `/deep-review`'s job at PR time; this gate has no persona fan-out.
